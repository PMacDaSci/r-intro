...
Code goes in **code chunks**, denoted by three backticks *`*. Try executing this chunk by clicking the *Play* button within the chunk or by placing your cursor inside it and pressing *Crtl+Shift+Enter* (Windows) or *Cmd+Shift+Enter* (Mac). 
