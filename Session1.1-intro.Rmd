...
author: PMacDaSci's modified version of material by Mark Dunning, Suraj Menon and Aiora Zabala, Robert Stojnić,
  Laurent Gatto, Rob Foy, John Davey, Dávid Molnár and Ian Roberts (original material https://github.com/cambiotraining/r-intro) and Software Carpentry.
...
## Introduction to RStudio (from Software Carpentry)
...
- `edgeR` is a Bioconductor package (http://www.bioconductor.org) for the analysis of RNA-seq data:
...
##Example: Load packages ggplot2 and edgeR
...
library(edgeR)   # loads edgeR functions
